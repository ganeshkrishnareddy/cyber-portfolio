...
export default function sitemap(): MetadataRoute.Sitemap {
    const base = 'https://pganeshkrishnareddy.vercel.app';
    const now = new Date();
    ...
    return [
        ...
        { url: `${base}/security-research`, lastModified: now, changeFrequency: 'weekly', priority: 1 },
        { url: `${base}/journey`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
        { url: `${base}/build-log`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
